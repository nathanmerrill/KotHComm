...
public final class PipeCommunicator implements Communicator<String, String> {
    ...
    public String sendMessage(String message, String method, int timeout) {
        try {
            ...
            throw new CommunicationException("Unable to communicate with "+directory.getName()+". Method: "+method+" Message: "+message, e);
        }
    }
    ...
    private IOPipe start(ProcessBuilder builder){
        try {
            ...
            throw new CommunicationException("Invalid commands passed to process", e);
        }
    }
